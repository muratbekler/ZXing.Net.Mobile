...
namespace ZXing.Mobile.CameraAccess
{
    public class CameraController
    {
        ...
        public void AutoFocus(int x, int y)
        {
            ...
            //double xx = (x / _surfaceView.Width);
            //double focusX = xx * 2000 - 1000;
            //double focusY = (y / _surfaceView.Height) * 2000 - 1000;

            // Call the autofocus with our coords
            AutoFocus((int)x, (int)y, true);
        }
        ...
        private void AutoFocus(int x, int y, bool useCoordinates)
        {
            ...
            try
            {
                ...
                if (useCoordinates && cameraParams.SupportedFocusModes.Contains(Camera.Parameters.FocusModeAuto))
                {
                    int focus = 80;
                    ...
                    Rect targetFocusRect = new Rect(
                           touchRect.Left * 2000 / cameraParams.PreviewSize.Width - 1000,
                           touchRect.Top * 2000 / cameraParams.PreviewSize.Height - 1000,
                           touchRect.Right * 2000 / cameraParams.PreviewSize.Width - 1000,
                           touchRect.Bottom * 2000 / cameraParams.PreviewSize.Height - 1000);

                    cameraParams.FocusMode = (Camera.Parameters.FocusModeAuto);
                    List<Camera.Area> meteringAreas = new List<Camera.Area>();
                    meteringAreas.Add(new Camera.Area(targetFocusRect, 800));
                    cameraParams.FocusAreas = (meteringAreas);
