	...
	public class ZxingOverlayView : View 
	{
		...
		protected override void OnDraw (Canvas canvas)
		{
			...
			else
			{
                ...
                int middlev = frame.Width() / 2 + frame.Left;
                canvas.DrawRect(middlev - 1, frame.Top + 2, middlev + 2, frame.Bottom - 1, paint);
                
                //frame.Top + 2, middle - 1, frame.Bottom - 1, middle + 2, paint);
